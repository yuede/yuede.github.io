...
<span style="color:blue">Publications</span>: [TLPGNN [HPDC'22]](../files/22_hpdc_TLPGNN.pdf), [Aquila [HPDC'20]](../files/20_HPDC_Aquila.pdf), [SwarmGraph [HPCC'20]](../files/20_HPCC_SwarmGraph.pdf), [iSpan [SC'18]](../files/18_SC_iSpan.pdf)
